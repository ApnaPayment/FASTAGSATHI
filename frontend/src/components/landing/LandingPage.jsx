  ...
  return (
    <div data-testid="home-page">
      <SEO
        ...
        jsonLd={[orgSchema, websiteSchema, faqSchema([
          ...
          { q: "How much does it cost?", a: "Free to sign up. You pay ₹49–₹199 only when a Sathi successfully resolves your issue." },
          { q: "Where are Sathis available?", a: "Currently live at 60+ toll plazas across NH-48, NH-44, NH-19. Expanding to 200+ plazas by Q2 2026." },
        ])]}
      />
      <Hero />
      <TrustBar />
